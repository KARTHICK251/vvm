...
<section class="category">
   ...
   <h1 class="heading">Fashion Changes But <span style="color:#287fb8"> Style Endures<span></h1>
   ...
   <a  class="swiper-slide slide">
      <img src="images/leggins1.png" alt="">
      <h3>leggins</h3>
   </a>
